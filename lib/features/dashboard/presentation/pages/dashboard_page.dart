...
// Custom slide transition untuk gunakan page
Route _createRoute(Widget page) {
  return PageRouteBuilder(
    ...
    transitionsBuilder: (context, animation, secondaryAnimation, child) {
      ...
      final curvedAnimation = animation.drive(tween.chain(CurveTween(curve: curve)));
      return SlideTransition(position: curvedAnimation, child: child);
    },
