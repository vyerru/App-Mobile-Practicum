...
import 'package:run/features/dosen/data/models/dosen_model.dart'; // Pastikan path ini sesuai dengan nama project Anda
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          // Daftar warna gradient default jika AppConstants tidak digunakan
